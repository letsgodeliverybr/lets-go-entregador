-- Corrige solicitar_saque: gorjeta era tratada como fallback exclusivo da taxa,
-- nunca sendo somada quando taxa_motoboy > 0. Agora usa taxa_motoboy + gorjeta,
-- alinhando com o cálculo de saldo_semana.dart e com todas as telas do app.
