    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Revise os dados antes de confirmar:', style: TextStyle(color: Colors.white70, fontSize: 14)),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Valor do saque', style: TextStyle(color: Colors.white70, fontSize: 13)),
              const SizedBox(height: 8),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Conta de destino', style: TextStyle(color: Colors.white70, fontSize: 13)),
              ...
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text('Agência: ${widget.conta['agencia']}  •  Conta: ${widget.conta['conta']}', style: const TextStyle(color: Colors.white70, fontSize: 12)),
                  const SizedBox(height: 2),
                  Text('CPF: ${widget.conta['cpf']}', style: const TextStyle(color: Colors.white70, fontSize: 12)),
                ])),
              ]),
            ]),
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text('Seu saque foi solicitado com sucesso.\nO valor será depositado em até 1 dia útil.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white70, fontSize: 14, height: 1.5)),
